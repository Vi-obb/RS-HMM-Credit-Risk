...
The distinction matters for the journal context. \emph{Scientific African} aims to support African research and research capacity, but the present data do not describe an African portfolio. The transferable contribution is a transparent method for testing whether regime-aware credit models survive forecast-like temporal evaluation. The United States results are not evidence about African borrowers, institutions, or macroeconomic transmission. A regional application would require locally defined outcomes, locally meaningful indicators, and external validation on African credit data.
